...
Это еще один тестовый репозиторий связанный с Яндекс Практикум. Здесь будет все, что я узнал о работе с Git и GitHub. В дальнейшем это поможет мне, ну а может быть и еще кому-то...


### Дальнейшее развитие проекта


Проект будет иметь развитие пока Я прохожу Яндекс Практикум по Git :(
